...
1 - Criando um abiente virtual para a pasta nova
...
Quando abrimos no navegador, vamos o retorno da API. Podemos clicar em 'inspecionar' na tela no navegador e ir na aba 'network' pra saber sobre as informações da API
...
Outra forma mais fácil e recomendada de fzer isso é atravéz de uma entreda no código do arquivo 'main', colocamos da seguinte forma: 
